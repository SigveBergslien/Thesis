...
public:
	...
	*/
	...
	void SetTexture(const string tex)			{texture = SOIL_load_OGL_texture(tex.c_str(), SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_COMPRESS_TO_DXT);}

	void Explosion() { explosion = true; }

	void SetRands(int r1, int r2) { rand1 = r1; rand2 = r2; }
protected:
	/*
	...
	*/
	...
	vector<Particle*>	particles;	//Active particles stay in here :)
	vector<Particle*>	freeList;	//'Spare' particles stay in here...
};
